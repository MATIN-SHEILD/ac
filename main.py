...
#           ---         ---         ---         #
api_id = 2802662 # ایپی ایدی
api_hash = 'b8a41227faa9481313ecfa661ef50ef4' # ایپی هش
bot_token = '1306581721:AAEV1UFuNOTViRlOSLjJuCf41uB9U14EDNk' # توکن ربات
bot_admins = [906884517, 5099121177] # ادمین های ربات
source = "@MATIN_SHEILD" #دست نزنید
sleeping = 2 # دست نزنید
step = None # دست نزنید
tempClient = dict() # دست نزنید
isWorking = list() # دست نزنید
#اوپن شده توسط چنل متین شیلد
#@MATIN_SHEILD
